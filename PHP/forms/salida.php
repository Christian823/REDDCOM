...
$sqlHoraSalida = "SELECT horaSalida FROM registros WHERE horaSalida <> '' AND user = ? AND fecha = ?";
...
if (!empty($horaSalidaExistente)) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlHoraEntrada = "SELECT horaEntrada FROM registros WHERE user = ? AND fecha = ?";
